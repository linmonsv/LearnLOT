                              ...
                              )
{
    ...
    phKeyStore_Sw_KeyVersionPair_t * pKeyVersion = NULL;
                                ...
                                )
{
    ...
    (void)memcpy(pKeyVersion->pKey, pNewKey, phKeyStore_GetKeySize(wKeyType));
    ...
    )
{
    ...
    for (i=0; i < wNoOfKeys ; i++)
    {
        ...
        (void)memcpy(pKeyVersion->pKey, &pNewKeys[(i*bKeyLength)], bKeyLength);
    }
                                ...
                                )
{
    ...
    /* copy the key */
    (void)memcpy(pKey, pKeyVersion->pKey, wKeySize);
