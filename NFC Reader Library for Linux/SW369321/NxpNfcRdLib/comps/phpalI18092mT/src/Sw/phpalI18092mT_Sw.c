    ...
    )
{
    ...
    uint16_t    PH_MEMLOC_REM wTxSettings;
    uint16_t    PH_MEMLOC_REM wRxSettings;
    uint8_t     PH_MEMLOC_REM bCmdLen = 0;
    uint16_t    PH_MEMLOC_REM a18092T_DrTable[3] = {PHHAL_HW_RF_DATARATE_106, PHHAL_HW_RF_DATARATE_212, PHHAL_HW_RF_DATARATE_424};
