...
/** \file
* Internal functions for MIFARE product application layer.
* $Author$
* $Revision$ (v05.22.00)
* $Date$
*
                             ...
                             )
{
    ...
    if ((status & PH_ERR_MASK) != PH_ERR_IO_TIMEOUT)
    {
        ...
        return PH_ADD_COMPCODE_FIXED(PH_ERR_PROTOCOL_ERROR, PH_COMP_AL_MFC);
    }
    ...
    )
{
    ...
    case PHAL_MFC_RESP_NAK0:
        return PH_ADD_COMPCODE_FIXED(PHPAL_MIFARE_ERR_NAK0, PH_COMP_PAL_MIFARE);
    case PHAL_MFC_RESP_NAK1:
        return PH_ADD_COMPCODE_FIXED(PHPAL_MIFARE_ERR_NAK1, PH_COMP_PAL_MIFARE);
    case PHAL_MFC_RESP_NAK4:
        return PH_ADD_COMPCODE_FIXED(PHPAL_MIFARE_ERR_NAK4, PH_COMP_PAL_MIFARE);
    case PHAL_MFC_RESP_NAK5:
        return PH_ADD_COMPCODE_FIXED(PHPAL_MIFARE_ERR_NAK5, PH_COMP_PAL_MIFARE);
    default:
        return PH_ADD_COMPCODE_FIXED(PH_ERR_PROTOCOL_ERROR, PH_COMP_AL_MFC);
    }
}
