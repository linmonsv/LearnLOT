                                        ...
                                        )
{
    ...
    {
        status = PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_DATA_PARAMS, PH_COMP_PAL_I18092MPI);
                              ...
                              )
{
    ...
    if (0U != (bGiLength)) PH_ASSERT_NULL (pGi);
                                   ...
                                   )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phpalI18092mPI_Transmit");
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wOption);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(pTxBuffer);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
        status = phpalI18092mPI_Sw_Transmit((phpalI18092mPI_Sw_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength);
        break;
#endif /* NXPBUILD__PHPAL_I18092MPI_SW */
                                  ...
                                  )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phpalI18092mPI_Receive");
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wOption);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(ppRxBuffer);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
        status = phpalI18092mPI_Sw_Receive((phpalI18092mPI_Sw_DataParams_t *)pDataParams, wOption, ppRxBuffer, pRxLength);
        break;
#endif /* NXPBUILD__PHPAL_I18092MPI_SW */
                                 ...
                                 )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phpalI18092mPI_Wakeup");
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
    PH_ASSERT_NULL (pDataParams);
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
        status = phpalI18092mPI_Sw_Wakeup((phpalI18092mPI_Sw_DataParams_t *)pDataParams);
        break;
#endif /* NXPBUILD__PHPAL_I18092MPI_SW */
