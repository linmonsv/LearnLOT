...
#if !defined(PH_NXPNFCRDLIB_CONFIG_HAL_TX_BUFFSIZE) && !defined(NXPBUILD__PHHAL_HW_RC663)
...
#if !defined(PH_NXPNFCRDLIB_CONFIG_HAL_RX_BUFFSIZE) && !defined(NXPBUILD__PHHAL_HW_RC663)
...
#if defined(NXPBUILD__PHHAL_HW_RC663) && defined(PH_NXPNFCRDLIB_CONFIG_HIGHER_FSDI)
    #define PH_NXPNFCRDLIB_CONFIG_FSDI_VALUE                     10U      /**< With RC663 we can configure the required FSDI value. But as frame error detection with CRC16 is not good beyond 1KBytes Limiting the value to 10. */
    #define PH_NXPNFCRDLIB_CONFIG_FSCI_VALUE                     10U      /**< With RC663 we can configure the required FSCI value. But as frame error detection with CRC16 is not good beyond 1KBytes Limiting the value to 10. */
#endif
