            ______________________________________________________
              ...
              NXPNFCRDLIB EXAMPLE : NFCRDLIB_SIMPLIFIEDAPI_EMVCO
                                  (V05.22.00)
            ______________________________________________________
...
1 Document Purpose
2 Description of the Nfcrdlib_SimplifiedAPI_EMVCo
3 Restrictions on Nfcrdlib_SimplifiedAPI_EMVCo
4 Configurations of Nfcrdlib_SimplifiedAPI_EMVCo
5 Package Contents
6 Mandatory materials (not included)
7 Hardware Configuration
8 Software Configuration
9 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo for LPC1769 with PN5180 using MCUXpresso
10 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo for LPC1769 with RC663 using MCUXpresso
11 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo for PN7462AU using MCUXpresso
12 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo for FRDM-K82F using MCUXpresso
13 Selection of Board / OSAL / Frontend (MCUXpresso)
14 Steps to follow for PI / Linux / CMake
15 Running Nfcrdlib_SimplifiedAPI_EMVCo
...
==================
  ...
  Nfcrdlib_SimplifiedAPI_EMVCo example as well as it's known problems and
  restrictions.
...
=================================================
  ...
  - Nfcrdlib_SimplifiedAPI_EMVCo can be run with CLEV663B, PN5180 and PN7462AU.
    (See Section-16 for supported versions)
  This example is a LoopBack Application which is used to perform EMVCo L1
  digital compliance validation.  The CPU frequency configured for the Host
...
==============================================
  ...
  - Nfcrdlib_SimplifiedAPI_EMVCo is restricted to be run on NFC Reader
...
================================================
  ...
  - This example can be used for running either EMVCo3.0(L1) or EMVCo2.6(L1)
    digital compliance validation.
  - This example has been verified using the MP500 Test Tool.

    Note: To execute EMVCo2.6(L1) digital compliance with RC663 refer
    Section-10.
...
==================
  ...
  - Readme.txt
    + This readme file
  - Nfcrdlib_SimplifiedAPI_EMVCo.c
    + Main example file.
  - intfs/Nfcrdlib_SimplifiedAPI_EMVCo.h
...
======================================================================================
  ...
  Bullet-3 below) For EMVCo2.6(L1) digital compliance validation,
  PH_NXPNFCRDLIB_CONFIG_HIGHER_FSDI macro need to be commented in
  intfs/ph_NxpBuild_App.h file for RC663 compilation.
...
=======================================
  ...
  The running application can now be used for either EMVCo3.0 or EMVCo2.6 Test
  suite validation.
