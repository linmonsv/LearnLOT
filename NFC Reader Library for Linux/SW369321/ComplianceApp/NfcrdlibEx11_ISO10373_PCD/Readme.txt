            ______________________________________________________
                ...
                NXPNFCRDLIB EXAMPLE : NFCRDLIBEX11_ISO10373_PCD
                                  (V05.22.00)
            ______________________________________________________
...
1 Document Purpose
2 Description of the NfcrdlibEx11_ISO10373_PCD
3 Restrictions on NfcrdlibEx11_ISO10373_PCD
4 Configurations of NfcrdlibEx11_ISO10373_PCD
5 Package Contents
6 Mandatory materials (not included)
7 Hardware Configuration
8 Software Configuration
9 Steps to build NfcrdlibEx11_ISO10373_PCD for LPC1769 with PN5180 using MCUXpresso
10 Steps to build NfcrdlibEx11_ISO10373_PCD for LPC1769 with RC663 using MCUXpresso
11 Steps to build NfcrdlibEx11_ISO10373_PCD for PN7462AU using MCUXpresso
12 Steps to build NfcrdlibEx11_ISO10373_PCD for FRDM-K82F using MCUXpresso
13 Selection of Board / OSAL / Frontend (MCUXpresso)
14 Running NfcrdlibEx11_ISO10373_PCD
...
==================
  ...
  NfcrdlibEx11_ISO10373_PCD example as well as it's known problems and
  restrictions.
...
==============================================
  ...
  - NfcrdlibEx11_ISO10373_PCD can be run with CLEV663B, PN5180 and PN7462AU.
    (See Section-15 for supported versions)
  This example is a Application which is used to perform ISO 10373-6 PCD
  compliance validation.  This example has to be executed in the DUT which has
  an ISO 14443 based PCD implementation.  The ISO 10373-6 test methods verifies
  the compliance to the ISO 14443 protocols.

  NOTE : This application is developed based on Micropross user manual of ISO
  10373-6 PCD Test Suite v2.0.2 which is executed using MP500 TCL3 and is not
  executed with other tool ISO 10373-6 PCD test suite.


3 Restrictions on NfcrdlibEx11_ISO10373_PCD
===========================================

  - NfcrdlibEx11_ISO10373_PCD is restricted to be run on NFC Reader Boards/ICs
    mentioned in Section-15.
  - To execute the ISO PCD test bench using the configurations provided,
    Micropross MP500 TCL3 tool with ISO 10373-6 PCD test suite is required.
  ...
  - This software project requires NxpNfcRdLib v05.22.00 or later.
...
=============================================
  ...
  - This example can be used for running ISO 10373-6 PCD test suite mentioned
    in Section-2.
  - This example has been verified using the MP500 TCL3 Test Tool. To run with
    PCD test suite, load the Micropross test bench configuration file
    ISO10373_PCD_Test_Bench_Config.mpecc in Micropross PCD test suite.
...
==================
  ...
  - Readme.txt
    + This readme file
  - NfcrdlibEx11_ISO10373_PCD.c
    + Main example file.
  - intfs/NfcrdlibEx11_ISO10373_PCD.h
  ...
  - ISO10373_PCD_Test_Bench_Config.mpecc
    + Micropross ISO PCD test suite configuration file
...
========================
  ...
  - ISO 10373-6 PCD Test Bench: To run this project with ISO PCD test bench,
    load the configuration file ISO10373_PCD_Test_Bench_Config.mpecc in the
    Micropross PCD test suite.
...
====================================
  ...
  The running application can now be used for ISO 10373-6 PCD Test case
  validation.
...
==========================================
  ...
  3) PNEV7462C Customer Evaluation Board
