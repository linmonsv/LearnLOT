...
1 Document Purpose
2 Description of the Nfcrdlib_SimplifiedAPI_EMVCo_Interop
3 Restrictions on Nfcrdlib_SimplifiedAPI_EMVCo_Interop
4 Configurations of Nfcrdlib_SimplifiedAPI_EMVCo_Interop
5 Package Contents
6 Mandatory materials (not included)
7 Hardware Configuration
8 Software Configuration
9 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo_Interop for LPC1769 with PN5180 using MCUXpresso
10 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo_Interop for LPC1769 with RC663 using MCUXpresso
11 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo_Interop for PN7462AU using MCUXpresso
12 Steps to build Nfcrdlib_SimplifiedAPI_EMVCo_Interop for FRDM-K82F using MCUXpresso
13 Selection of Board / OSAL / Frontend (MCUXpresso)
14 Steps to follow for PI / Linux / CMake
15 Running Nfcrdlib_SimplifiedAPI_EMVCo_Interop
...
==================
  ...
  Nfcrdlib_SimplifiedAPI_EMVCo_Interop example as well as it's known problems
  and restrictions.
...
=========================================================
  ...
  - Nfcrdlib_SimplifiedAPI_EMVCo_Interop can be run with CLEV663B, PN5180 and
    PN7462AU.  (See Section-16 for supported versions)
  This example is a Interoperability LoopBack Application which is used to
  perform EMVCo2.6b(L1) with add-on(TTA Bulletin No.195) compliance
...
======================================================
  ...
  - Nfcrdlib_SimplifiedAPI_EMVCo_Interop is restricted to be run on NFC Reader
...
========================================================
  ...
  - This example can be used for running EMVCo2.6b(L1) with add-on(TTA Bulletin
...
==================
  ...
  - Readme.txt
    + This readme file
  - Nfcrdlib_SimplifiedAPI_EMVCo_Interop.c
    + Main example file.
  - intfs/Nfcrdlib_SimplifiedAPI_EMVCo_Interop.h
    + Interfaces/Defines specific to the example
  - intfs/Nfcrdlib_SimplifiedAPI_EMVCo_Interop_status.h
    + Interfaces/Defines specific to this example to enable and control LED's
      as well as GPIO's.
  - src/Nfcrdlib_SimplifiedAPI_EMVCo_Interop_status.c
...
===============================================
  ...
  The running application can now be used for EMVCo2.6b with add-on(TTA
  ...
  4) Raspberry Pi: Test success and fail indicated by Green LED
