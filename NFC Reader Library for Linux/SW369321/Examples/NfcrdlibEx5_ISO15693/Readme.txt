...
8 Steps to build NfcrdlibEx5_ISO15693 for LPC1769 with PN5180 using MCUXpresso
9 Steps to build NfcrdlibEx5_ISO15693 for LPC1769 with RC663 using MCUXpresso
10 Steps to build NfcrdlibEx5_ISO15693 for PN7462AU using MCUXpresso
11 Steps to build NfcrdlibEx5_ISO15693 for FRDM-K82F using MCUXpresso
12 Selection of Board / OSAL / Frontend (MCUXpresso)
13 Steps to follow for PI / Linux / CMake
14 Running NfcrdlibEx5_ISO15693
...
==================
  ...
  NfcrdlibEx5_ISO15693 example as well as it's known problems and restrictions.
...
======================================
  ...
  - NfcrdlibEx5_ISO15693 is restricted to be run on NFC Reader Boards/ICs
...
===============================
  ...
  example application will detect and displays the detected card information on
  console.
