...
9 Steps to build NfcrdlibEx2_AdvancedDiscoveryLoop for LPC1769 with PN5180 using MCUXpresso
10 Steps to build NfcrdlibEx2_AdvancedDiscoveryLoop for LPC1769 with RC663 using MCUXpresso
11 Steps to build NfcrdlibEx2_AdvancedDiscoveryLoop for PN7462AU using MCUXpresso
12 Steps to build NfcrdlibEx2_AdvancedDiscoveryLoop for FRDM-K82F using MCUXpresso
13 Selection of Board / OSAL / Frontend (MCUXpresso)
14 Steps to follow for PI / Linux / CMake
15 Running NfcrdlibEx2_AdvancedDiscoveryLoop
...
==================
  ...
  NfcrdlibEx2_AdvancedDiscoveryLoop example as well as it's known problems and
  restrictions.
...
======================================================
  ...
  - NfcrdlibEx2_AdvancedDiscoveryLoop can be run with CLEV663B, PN5180 and
