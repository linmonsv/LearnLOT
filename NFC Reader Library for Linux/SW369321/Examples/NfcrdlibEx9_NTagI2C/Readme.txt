...
8 Steps to build NfcrdlibEx9_NTagI2C for LPC1769 with PN5180 using MCUXpresso
9 Steps to build NfcrdlibEx9_NTagI2C for LPC1769 with RC663 using MCUXpresso
10 Steps to build NfcrdlibEx9_NTagI2C for PN7462AU using MCUXpresso
11 Steps to build NfcrdlibEx9_NTagI2C for FRDM-K82F using MCUXpresso
12 Selection of Board / OSAL / Frontend (MCUXpresso)
13 Steps to follow for PI / Linux / CMake
14 Running NfcrdlibEx9_NTagI2C
...
==================
  ...
  NfcrdlibEx9_NTagI2C example as well as it's known problems and restrictions.


2 Description of the NfcrdlibEx9_NTagI2C
========================================

  - NfcrdlibEx9_NTagI2C can be run with CLEV663B, PN5180 and PN7462AU.  (See
    Section-15 for supported versions)
  - This example will load/configure Discovery loop with NFC profile via
    SetConfig.
  - By using POLL mode of discovery loop, example will detect the NTag I2C
    cards and displays detected tag information like UID, ATQA, SAK, Version
    info, Page Read and Page Write status.
...
==============================
  ...
  Run the application and when you bring the NTag I2C in proximity, the example
  application will detect and displays the detected card information on
  console.
